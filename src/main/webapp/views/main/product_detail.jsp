        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="breadcrumb-tree">
                    ...
                    <li class="active"><c:out value="${product.getName()}"/></li>
                </ul>
            </div>
        </div>
        <!-- /row -->
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="product-details">
                    <h2 class="product-name"><c:out value="${product.getName()}"/></h2>
                    <div>
                    ...
                    <div>
                        <h3 class="product-price"><c:out value="${product.getPrice()}"/><del class="product-old-price"><c:out value="${product.getPrice()}"/></del></h3>
                        <span class="product-available">In Stock</span>
                    </div>
                    <p>Đây là một đoạn mô tả ngắn về sản phẩm.</p>
                                    ...
                                    <div id="reviews">
                                        <ul class="reviews">
                                            ...
                                            <li>
                                                ...
                                                <div class="review-body">
                                                    <p>Tôi rất hài lòng về chất lượng sản phẩm</p>
                                                </div>
                                            </li>
                                        </ul>
