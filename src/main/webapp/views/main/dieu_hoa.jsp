    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div id="aside" class="col-md-3">
                <!-- aside Widget -->
                <div class="aside">
                    <h3 class="aside-title">LOẠI ĐIỀU HÒA</h3>
...
<%--                    </div>--%>
            ...
            <div id="store" class="col-md-9">
                ...
                <div class="row">
                    ...
                    <%--&lt;%&ndash;                    <div class="clearfix visible-lg visible-md"></div>&ndash;%&gt;--%>
                    ...
                    <%--&lt;%&ndash;                    <div class="clearfix visible-lg visible-md visible-sm visible-xs"></div>&ndash;%&gt;--%>
